...
export const AgencyAccountSetup = () => {
    return (
        <CommonAuth image={AgencySetupBg} topic="Make Your Profile Stand Out" text="Upload a photo and choose a display name to get started"
                    section={
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <ImageUploadField
                                            ...
                                            subTopic="A business log reflects your agency professionalism, making a lasting first impression in today's digital world."
