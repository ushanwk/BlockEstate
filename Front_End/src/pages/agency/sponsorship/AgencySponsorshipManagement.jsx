...
import {AgencySponsorshipTable} from "./AgencySponsorshipTable.jsx";
        ...
        <main>
            ...
            <section className="w-full mt-5 rounded-[5px] bg-white dark:bg-[var(--color-dark-bg-primary)] border border-[var(--color-primary)]/10 flex flex-col">
                <div className="py-4 px-2 ml-3 mr-3 text-[12px] flex justify-between">
                    ...
                    <div className="w-36">
                        <Button green="green" children="New Sponsorship" onclick={()=>{navigate('add')}} />
                    </div>
                </div>
                <AgencySponsorshipTable filters={filters} />
            </section>
        </main>
    )
}